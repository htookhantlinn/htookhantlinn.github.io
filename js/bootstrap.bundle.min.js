  ...
  */!function (t, e) {
        ...
        r = (t, e, i) => {
            Object.keys(i).forEach(n => {
                ...
                if (!new RegExp(o).test(a))
                    throw new TypeError(`${t.toUpperCase()
    ...
    class Te extends H {
        ...
        static dataApiKeydownHandler(t) {
            ...
            if ("Escape" !== t.key)
                return "ArrowUp" === t.key || "ArrowDown" === t.key ? (e || n.show(), void n._selectMenuItem(t)) : void (e && "Space" !== t.key || Te.clearMenus());
    ...
    class Xe extends H {
        ...
        setElementContent(t, e) {
            if (null !== t)
                return s(e) ? (e = o(e), void (this._config.html ? e.parentNode !== t && (t.innerHTML = "", t.append(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = qe(e, this._config.allowList, this._config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
        ...
        _cleanTipClass() {
            const t = this.getTipElement(),
                e = new RegExp(`(^|\\s)${this._getBasicClassPrefix()
                    }\\S+`, "g"),
